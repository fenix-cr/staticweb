          ...
          >
            ...
            <b-list-group style="padding: 2px; margin-bottom: 2px" dense rounded>
              <router-link class="urlPagina"
                           :to="{ name: 'details-contract-fees', params: { id: item.id } }"
              >
...
export default {
    ...
    return {
      ...
      fields: [
     {
        ...
        },
        {
         ...
         {
          label: 'Contract Name',
          key: 'coporate_account_rate.ContractName',
           sortable: true
        },
        {
          label: 'Expiration Date',
          key: 'coporate_account_rate.ExpirationDate',
           sortable: true
        },
        {
          key: 'actions'
  ...
  methods: {
    getClientes() {
      ...
      this.$http.get('/admin/panel/ca/all/contractlist').then((response) => {
  ...
  mounted() {
    console.log(this.$http.get('/admin/panel/ca/contractlist'));
    this.getClientes();
  }
}
</script>
